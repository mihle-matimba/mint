...
const TransactComingSoonPage = ({ onBack, onOpenNotifications }) => {
          ...
          <div className="mt-10 grid gap-8 md:grid-cols-[1.15fr_0.85fr]">
            <section className="space-y-6">
              ...
              <h1 className="text-3xl font-semibold leading-tight md:text-4xl">
                Transactions are <span className="text-violet-200">coming soon</span>.
              </h1>
              <p className="max-w-xl text-sm text-white/75 md:text-base">
                We are building faster transfers, cleaner receipts, and smart spend controls so you can move money
                with confidence.
              </p>
              ...
              <div className="glass-card space-y-4 p-5 text-white">
                <div className="flex items-center gap-3 rounded-full bg-white/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-white/80">
                  Connecting your transfer orbit
                </div>
                ...
                <div className="rounded-2xl bg-white/10 p-4">
                  ...
                  <div className="mt-3 h-2 w-full rounded-full bg-white/10">
                    <div className="h-2 w-1/3 rounded-full bg-gradient-to-r from-white to-violet-200" />
                  </div>

                  <div className="mt-4 space-y-3">
                    <div className="rounded-2xl bg-white/10 px-4 py-3">
                      <p className="text-[11px] uppercase tracking-[0.2em] text-white/60">Send to</p>
                      <p className="mt-2 text-sm font-semibold text-white">Amahle Dlamini</p>
                    </div>
                    <div className="rounded-2xl bg-white/10 px-4 py-3">
                      <p className="text-[11px] uppercase tracking-[0.2em] text-white/60">Amount</p>
                      <p className="mt-2 text-sm font-semibold text-white">R 850.00</p>
                    </div>
                    <div className="rounded-2xl bg-white/10 px-4 py-3">
                      <p className="text-[11px] uppercase tracking-[0.2em] text-white/60">Speed</p>
                      <p className="mt-2 text-sm font-semibold text-white">Instant transfer</p>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 rounded-2xl border border-white/20 bg-white/5 px-4 py-3">
                    ...
                    <p className="mt-2 text-xs text-white/60">
                      Verify recipient once, then send in seconds.
                    </p>
                  </div>
                </div>
            ...
            <section className="flex flex-col items-center justify-start gap-6 rounded-3xl border border-white/15 bg-white/10 p-6 text-white backdrop-blur">
              ...
              <div className="text-center">
                <p className="text-xs uppercase tracking-[0.3em] text-white/60">MINT TRANSACT</p>
                <p className="mt-3 text-sm text-white/75">
                  Your transaction timeline will live here, with instant transfers, receipts, and spend controls.
                </p>
              </div>
              <div className="w-full rounded-2xl border border-white/20 bg-white/10 px-4 py-4 text-left text-xs text-white/70">
                ...
                <p className="mt-2">Transfers, beneficiaries, scheduled payments, and smart spend alerts.</p>
              </div>
            </section>
          </div>
        </div>
...
export default TransactComingSoonPage;
