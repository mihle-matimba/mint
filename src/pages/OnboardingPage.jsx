...
const OnboardingPage = ({ onCreateAccount, onLogin }) => {
  return (
    <div className="min-h-screen bg-white">
      <div className="grid min-h-screen grid-rows-[minmax(0,1fr)_minmax(0,1fr)] lg:grid-cols-[1.05fr_1fr] lg:grid-rows-none">
        <div className="order-2 flex min-h-0 flex-col px-6 pb-8 pt-8 lg:order-1 lg:px-16 lg:pb-16 lg:pt-12">
          ...
          <div className="mx-auto flex w-full max-w-xl flex-1 flex-col justify-center space-y-6 lg:space-y-8">
