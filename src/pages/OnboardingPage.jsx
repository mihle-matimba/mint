...
const OnboardingPage = ({ onCreateAccount, onLogin }) => {
  return (
    <div className="min-h-[100svh] w-full overflow-hidden bg-white flex flex-col items-center justify-center px-6 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
